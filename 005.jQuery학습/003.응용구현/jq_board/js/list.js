...
// 데이터 idx의 내림차순으로 정렬변경하기! (숫자형데이터로 변환)
bData.sort((a, b) =>
...
// 2. 개수만큼 리스트에 데이터를 반복문으로 생성한다
// 3. 페이지 번호에 따라 시작번호를 업데이트 한다

// 페이징 관련 변수
// [1] 한페이지당 리스트 수 : pgBlock
const pgBlock = 9;
// [2] 페이지 순번 : pgNum -> 증감예정
let pgNum = 1;
...
// 사용데이터 : pagingBlock - 기본 페이지수 , addOver - 추가페이지 여부
const pNumBlock = $('.paging');
let pNumCode = '';

// 새로운 블록을 위한 변수
let newPagingBlock;
//추가 리스트가 있을경우 나머지가 0이 아니므로 다음페이지 추가!
