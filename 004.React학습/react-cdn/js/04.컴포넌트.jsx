...
// 출력 : #root3
ReactDOM.render(
    <Favorite color="빨간색" food="떡볶이" hobby="게임"/>,document.querySelector('#root3')
);
...
ReactDOM.render(
    <Favorite color="스카이블루" food="까르보나라" hobby="축구"/>,document.querySelector('#root4')
);
...
// #root5에 출력하기
ReactDOM.render(
    <Who/>,document.querySelector('#root5'));


// #root6에 외부 JSX파일 컴포넌트 출력하기
ReactDOM.render(
