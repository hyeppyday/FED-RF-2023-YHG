...
// 과일 이미지 요소를 화면에 출력해 준다 !
// 배열구성을 수정, 삭제 등 배열메서드로 변경 할 수 있게 한다!
...
// 데이터가 객체이기 때문에 for in 사용 / 배열일 경우엔 forEach
// option 태그 변수
// let opTag = '';
// for(let x in frObj){ 
    //     // x - 객체의 속성 / frObj[x] - 객체 값
    //     console.log(x);
    //     // 내용 넣기
    ...
    // 객체형식 - {키:값}
    // 키만 가지고 배열로 변환하는 Object객체의 메서드 : keys()
    // Object.key(객체) -> 객체의 키를 값으로 하는 배열생성 !!!
    //////////////////////////////////////////////////////////////
    sel.innerHTML =
    Object.keys(frObj).map(v=>`<option>${v}</option>`).join('');
