...
function slideFn(selEl) { //selEl 선택 슬라이드 요소
    ...
    // 1.5. li리스트에 순번속성만들어 놓기
    // 만드는 이유: 블릿변경등에 현재 슬라이드 순번 필요!!
