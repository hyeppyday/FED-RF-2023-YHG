...
import { catListData } from "../data/swipercat";
...
export function Searching(props) {
  ...
  /////////////// 후크 상태관리 변수 ////////////////////
  // 1. 검색어 후크 상태변수 : 초기값은 전달된 검색어 안넣음
