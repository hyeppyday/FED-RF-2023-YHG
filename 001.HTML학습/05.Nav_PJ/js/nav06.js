...
/*************************************************** 
  ...
  -> 구분자가 없는 태그로만 구성된 최종 데이터를 그자리에 출력한다 !
  ->>>> 잊지말자 !!!! 맵 + 쪼인 !

  ___________________________________________________

  const aa = ['신숙','상호','경미'];
  -> 배열데이터는 이름인데 뒤에 '씨'를 붙여서 보관하기
  aa = aa.map(val=>val+'씨');
  -> 결과 : ['신숙씨','상호씨','경미씨']
***************************************************/
// const aa = ['신숙','상호','경미'];
...
// ul>li>a[href='#']{1차}+.smenu>aside.smbx>h2>(.stit{1차}+a[href='#']{전체보기})+.swrap>dl>dt{2차}+dd>a[href='#']{3차}{요기}
